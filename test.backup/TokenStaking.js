...
contract('LaunchStaking', async(accounts) => {
  ...
  before(async () => {
    ...
    tokenStaking = await LaunchStaking.new(testToken.address);
  ...
  // Test 2
  // 2.1 Checking if LaunchStaking contract has a same name as expected
  describe('LaunchStaking deployment', async () => {
    ...
    // 2.4 Checking if LaunchStaking contract has 500k of TestTokens
  ...
  describe('LaunchStaking stakeTokens function', async () => {
    let result;
    ...
    // 3.2 checking LaunchStaking total banalce
    ...
    // 3.4 checking balance of LaunchStaking contract should be 500k +1000
    ...
    // 3.5 checking LaunchStaking contract users balance
    ...
    // 3.6 checking LaunchStaking totalstaked balance
  ...
  // Test 4
  describe('LaunchStaking redistributeRewards function', async () => {
    let result;
    ...
    // 4.2 checking balance of LaunchStaking contract after redistribution
    it('checking LaunchStaking balance', async () => {
      result = await testToken.balanceOf(tokenStaking.address);
      assert.equal(
        result.toString(),
        tokenCorvert('500999'),
  ...
  // Test 5
  describe('LaunchStaking unstakeTokens function', async () => {
    let result;
    ...
    // 5.2 checking LaunchStaking total staked balance
    it('checking total staked', async () => {
      result = await tokenStaking.totalStaked();
      assert.equal(
        result.toString(),
  ...
  // Test 6
  describe('LaunchStaking [custom] staking/unstaking functions', async () => {
    let result;
    // 6.1 checking LaunchStaking total custom staking banalce
