...
contract LPadPresale is Ownable, Whitelist {
    ...
    // IUniswapV2Router01 public UniswapV2Router02;
    Pool public pool;
    ...
    constructor(
        ...
        // UniswapV2Router02 = IUniswapV2Router01(_uniswapv2Router);
    ...
    */
    ...
    function isStartTime() public view returns (uint256) {
         return pool.startTime;
    }

    function isEndTime() public view returns (uint256) {
         return pool.endTime;
    }
